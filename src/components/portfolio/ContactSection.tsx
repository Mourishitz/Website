    ...
    try {
      ...
      const result = await emailjs.send(
        ...
        templateId,
        {
          ...
          to_email: 'gabrielmorishita@hotmail.com', // Your email
        },
        publicKey
      );
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <SectionHeader
          ...
          description="You can reach out to me for freelance projects, collaborations, or any inquiries you may have. I look forward to hearing from you! If you want a project for your business, RVG got you covered!"
