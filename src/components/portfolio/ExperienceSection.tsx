...
const experience = [
  {
    ...
    description:
      "Working as a Backend Developer at Infocar Technologies, focusing on developing and maintaining robust backend systems for various applications.",
    achievements: [
      "Designed and implemented RESTful APIs for multiple applications",
      "Improved application performance by optimizing database queries",
      "Collaborated with frontend developers to integrate APIs seamlessly",
      "Implemented security measures to protect sensitive data",
      "Contributed to the development of micosservices and monolith architecture",
    ],
    technologies: [
      "Laravel",
      "PHP",
  ...
  },
  {
    ...
    type: "Internship",
    companyIcon: "tabler:brand-disney",
    companyColor: "from-blue-500 to-blue-600",
    description:
      "Participated in the Disney College Program, gaining hands-on experience in customer service and problem solving at Walt Disney World.",
    achievements: [
      "Provided exceptional guest service in a fast-paced environment",
      "Collaborated with a diverse team to enhance guest experiences",
      "Learned Disney's customer service standards and operational procedures",
      "Developed strong communication and problem-solving skills",
      "Over 10 recognitions for outstanding service and teamwork from coordinators and guests",
    ],
    technologies: [
      "Customer Service",
      "Problem Solving",
  ...
  },
  {
    ...
    company: "SQAD Technologies",
    period: "April 2022 - November 2022",
    type: "Trainee",
    companyColor: "from-gray-500 to-gray-600",
    companyIcon: "tabler:square-letter-s",
    description:
      "Worked as a Junior Full Stack Developer, designing and creating web applications using SPA and API architectures.",
    achievements: [
      "Contributed to the development of a web-based applications",
      "Collaborated with other developers to implement new features and fix bugs",
      "Gained hands-on experience with full stack development using modern technologies",
      "Learned Agile methodologies and participated in daily stand-ups and sprint planning sessions",
    ],
    technologies: [
      "TypeScript",
      "React",
