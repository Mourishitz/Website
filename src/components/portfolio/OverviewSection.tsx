    ...
    >
      ...
      >
        <SectionHeader
          ...
          heading="About Me"
          description="Read about my journey, skills, and what drives me as a developer."
          showUnderline={true}
          centered={true}
        />
                ...
                <div className="space-y-4 md:space-y-6">
                  <div>
                    ...
                    <p className="text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-4 md:mb-6">
                      ...
                      making professional, high-end and scalable software.
                    </p>
                  </div>
                  ...
                  <div className="space-y-3 md:space-y-4 border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                      I specialize in backend development with a focus on
                      performance and scalability. My expertise includes
                      building robust APIs, integrating AI solutions, and
                      leveraging cloud technologies to deliver high-quality
                      software solutions. I have a strong foundation in both
                      front-end and back-end technologies, allowing me to create
                      seamless user experiences while ensuring optimal server
                      performance.
                    </p>
                    <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                      Beyond work, I am passionate about continuous learning and
                      exploring new technologies. I study as a hobby and read
                      books on software architecture, computer science, and
                      mathematics to deepen my understanding of complex systems.
                    </p>
                  </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                ...
                >
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                    Participated in the Disney College Program, gaining valuable
                    experience in customer service and operations at one of the
                    world&apos;s most iconic entertainment companies. Developed
                    skills in teamwork, problem-solving, and guest relations
                    while working in a fast-paced environment.
                  </p>
                  <div className="flex items-center gap-2 text-xs md:text-sm mt-auto">
                    <Icon
                      icon="tabler:mickey-filled"
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">
                        2024 — Current • {new Date().getFullYear() - 2024} year{" "}
                        {new Date().getFullYear() - 2024 > 1 ? "s" : ""}
                      </p>
                    </div>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                    Co-founder of a B2B software development company,
                    specializing in custom software solutions for businesses.
                    Main developer for various projects, focusing on backend
          ...
          >
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/90 to-pink-50/90 dark:from-purple-950/30 dark:to-pink-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3">
                <motion.a
                  href="mailto:gabrielmorishita@hotmail.com"
                ...
                {[
                  {
                    ...
                    text: "Bilingual: English & Portuguese",
                    color: "text-yellow-600",
                  },
                  {
                    icon: "hugeicons:time-02",
                    text: "1000+ Hours of Coding",
                    color: "text-blue-600",
                  },
                  {
                    icon: "streamline-sharp:user-work-laptop-wifi-solid",
                    text:
                      "Over " +
