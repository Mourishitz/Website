  ...
  return (
    <div className="relative min-h-[100dvh] flex items-center justify-center">
      ...
      >
        ...
        >
          Passionate about developing performance-driven web applications and
          creating delightful user experiences. I specialize in building
          scalable and maintainable software solutions using modern web
          technologies.
        </motion.p>
        ...
        >
          {[
            {
              href: "https://github.com/Mourishitz",
              icon: "simple-icons:github",
              label: "GitHub",
              color: "hover:text-gray-900 dark:hover:text-white",
            },
            {
              href: "https://linkedin.com/in/gabriel-morishita",
